<template>
    <div class="head">
        ...
        <ul class="head-list">
            <li class="list-item">
                <router-link to="/movie" style="color:#2384E8;">电影</router-link>
            </li>
            <li class="list-item">
                <router-link to="/book" style="color:#9F7860;">图书</router-link>
            </li>
            <li class="list-item">
                <router-link to="/radio" style="color:#E4A813;">广播</router-link>
            </li>
            <li class="list-item">
                <router-link to="/" style="color:#2AB8CC;">音乐</router-link>
            </li>
            <li class="list-item" @click="showMenu">
                <a href="#"><i class="fa fa-list fa-lg"></i></a>
            </li>
        </ul>
    </div>
</template>
